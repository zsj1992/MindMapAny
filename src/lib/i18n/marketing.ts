...
const en: MarketingCopy = {
  ...
  home: {
    ...
    inputLabels: ['Long text', 'PDF', 'Word', 'EPUB', 'PPTX', 'Web articles', 'YouTube'],
...
const zhCN: MarketingCopy = {
  ...
  home: {
    ...
    inputLabels: ['长文本', 'PDF', 'Word', 'EPUB', 'PPTX', '网页文章', 'YouTube'],
    sourceDocLabel: '原始文档',
...
const ja: MarketingCopy = {
  ...
  home: {
    ...
    inputLabels: ['長文テキスト', 'PDF', 'Word', 'EPUB', 'PPTX', 'ウェブ記事', 'YouTube'],
    sourceDocLabel: '元の文書',
...
const ko: MarketingCopy = {
  ...
  home: {
    ...
    inputLabels: ['긴 텍스트', 'PDF', 'Word', 'EPUB', 'PPTX', '웹 기사', 'YouTube'],
...
const es: MarketingCopy = {
  ...
  home: {
    ...
    inputLabels: ['Texto largo', 'PDF', 'Word', 'EPUB', 'PPTX', 'Artículos web', 'YouTube'],
...
const de: MarketingCopy = {
  ...
  home: {
    ...
    inputLabels: ['Langer Text', 'PDF', 'Word', 'EPUB', 'PPTX', 'Webartikel', 'YouTube'],
...
const fr: MarketingCopy = {
  ...
  home: {
    ...
    inputLabels: ['Texte long', 'PDF', 'Word', 'EPUB', 'PPTX', 'Articles web', 'YouTube'],
