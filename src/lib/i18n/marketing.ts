...
const ja: MarketingCopy = {
  ...
  pricing: {
    ...
    mostPopular: '人気',
    subscribeYearly: '年払いで登録',
    subscribeMonthly: '月払いで登録',
    limitFastOnly: '高速モデル',
    ...
    plans: {
      ...
      pro: {
        ...
        price: '$17.99 / 月',
        annualPrice: '$129.48 / 年（月あたり $10.79）',
        creditLabel: 'クレジット / 月',
      ...
      unlimited: {
        ...
        price: '$26.99 / 月',
        annualPrice: '$194.28 / 年（月あたり $16.19）',
  ...
  pricing: {
    ...
    plans: {
      ...
      pro: {
        ...
        price: '$17.99 / 월',
        annualPrice: '$129.48 / 년 (월 $10.79 꼴)',
        creditLabel: '크레딧 / 월',
      ...
      unlimited: {
        ...
        price: '$26.99 / 월',
        annualPrice: '$194.28 / 년 (월 $16.19 꼴)',
        creditLabel: '크레딧 무제한',
  ...
  pricing: {
    ...
    plans: {
      free: {
        ...
        price: '$0',
        annualPrice: 'Gratis para siempre',
      ...
      basic: {
        ...
        price: '$8.99 / mes',
        annualPrice: '$64.68 / año (sale a $5.39 / mes)',
      ...
      pro: {
        ...
        price: '$17.99 / mes',
        annualPrice: '$129.48 / año (sale a $10.79 / mes)',
        creditLabel: 'créditos / mes',
      ...
      unlimited: {
        ...
        price: '$26.99 / mes',
        annualPrice: '$194.28 / año (sale a $16.19 / mes)',
