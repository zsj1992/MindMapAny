    ...
    <>
      ...
      <main>
        <article className="mx-auto max-w-4xl px-5 py-12 lg:px-8 lg:py-16">
          ...
          <div className="mt-14 rounded-2xl bg-[#102f53] px-6 py-10 text-center text-white"><h2 className="text-2xl font-bold">把方法用到你的内容上</h2><p className="mt-3 text-sm text-blue-100/80">从真实文本、文档或网页生成一张可编辑脑图。</p><Link href={post.relatedTool} className="btn mt-6 h-11 bg-white px-6 text-[#102f53]">打开相关工具 →</Link></div>
