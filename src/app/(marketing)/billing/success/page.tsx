  ...
  return (
    <main className="hero-glow flex min-h-[calc(100vh-4rem)] items-center px-5 py-14">
      ...
      <section className="mx-auto w-full max-w-xl rounded-3xl border bg-surface p-8 text-center shadow-xl shadow-brand-900/5 sm:p-11">
        ...
        <p className="mt-4 text-sm leading-7 text-text-muted">Your payment is being confirmed, which usually takes a few seconds. Head back to the workbench and refresh to see your new plan and credits. If you checked out with a different email than your account, contact support and we&apos;ll sort it out.</p>
